...
export const listPublicBanners = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ message: "Không lấy được banner", error: err.message });
  }
};
...
export const createBanner = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ message: "Không tạo được banner", error: err.message });
  }
};
...
export const updateBanner = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ message: "Không cập nhật được banner", error: err.message });
  }
};
...
export const deleteBanner = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ message: "Không xóa được banner", error: err.message });
  }
};
