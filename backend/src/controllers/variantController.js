...
export const listVariants = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({
        message: "KhÃ´ng láº¥y Ä‘Æ°á»£c biáº¿n thá»ƒ",
        error: err.message,
      });
  }
};
...
export const createVariant = async (req, res) => {
  try {
    ...
    if (!productExists)
      return res
        .status(400)
        .json({ message: "Sáº£n pháº©m khÃ´ng tá»“n táº¡i" });
    ...
    res
      .status(500)
      .json({
        message: "KhÃ´ng táº¡o Ä‘Æ°á»£c biáº¿n thá»ƒ",
        error: err.message,
      });
  }
};
...
export const updateVariant = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({
        message: "KhÃ´ng cáº­p nháº­t Ä‘Æ°á»£c biáº¿n thá»ƒ",
        error: err.message,
      });
  }
};
...
export const deleteVariant = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({
        message: "KhÃ´ng xÃ³a Ä‘Æ°á»£c biáº¿n thá»ƒ",
        error: err.message,
      });
  }
};
