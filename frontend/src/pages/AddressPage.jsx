      ...
      <div className="bg-white p-6 rounded shadow">
        <div className="flex justify-between items-start">
          <div>
            ...
            <div className="mt-3">
              <span className="inline-block px-2 py-1 text-sm border rounded text-primary border-primary">Mặc định</span>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-2">
            ...
            <button className="bg-gray-100 px-3 py-2 rounded text-sm">Thiết lập mặc định</button>
          </div>
        </div>
      </div>

      <div className="mt-6">
        <button className="bg-primary text-white px-4 py-2 rounded">+ Thêm địa chỉ mới</button>
      </div>
    </div>
  );
}
