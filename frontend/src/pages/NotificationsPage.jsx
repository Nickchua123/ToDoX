  ...
  return (
    <div className="flex items-center justify-between py-3 border-b">
      <div>
        ...
        <div className="text-sm text-gray-500">Mô tả nhỏ về cài đặt</div>
      </div>
      <div>
  ...
  return (
    <div>
      ...
      <div className="bg-white rounded shadow max-w-3xl overflow-hidden">
        <div className="p-6">
          <h3 className="font-medium mb-3">Email thông báo</h3>
          <Toggle label="Cập nhật đơn hàng" defaultOn={true} />
          <Toggle label="Khuyến mãi" defaultOn={false} />
          <Toggle label="Khảo sát" defaultOn={true} />
        </div>

        <div className="p-6 border-t">
          <h3 className="font-medium mb-3">Thông báo SMS</h3>
          <Toggle label="Khuyến mãi SMS" defaultOn={true} />
        </div>
      </div>
    </div>
  );
